...
<head>
    ...
    <title>Rare Stamps: Orders</title>
...
<div class="container-fluid">
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <form action="orders.php" method="post" class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input class="form-control" type="text" id="oid" name="order_id" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_id']; else echo sprintf('OID%02d',$nid); ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input class="form-control" type="text" id="odate" name="order_date" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; else echo date('d/m/Y'); ?>">
          </div>
        </div>
  ...
  <div class="row">
    ...
    try {
      ...
      $sql = $sql."tbl_orders_a173630.fld_customer_id = tbl_customers_a173630_pt2.fld_customer_id ORDER BY fld_order_id ASC LIMIT $start_from, $per_page" ;
    ...
    <tr>
      ...
      <td><?php echo date_format(date_create($orderrow['fld_order_date']), "d/m/Y h:s a"); ?></td>
  ...
  <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
    <nav>
        ...
        try {
          $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
          $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_orders_a173630");
          $stmt->execute();
          $result = $stmt->fetchAll();
