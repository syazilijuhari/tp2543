<!--
Matric Number: A173630
Name: Muhammad Syazili bin Juhari
-->
<?php
  $univ = array(
...
<form action="validate_biodata.php" method="post" enctype="multipart/form-data">
  <table border="1" cellpadding="10">
    ...
    <tr>
      <td>Address:</td>
      <td>
        <textarea name="address" cols="50" rows="5" placeholder="Insert your address"></textarea>
      </td>
    </tr>
    <tr>
      <td>Email:</td>
    ...
    <tr>
      <td>Height:</td>
      <td>
        <input type="range" name="height" id="heightId" min="100" max="200" value="150" oninput="outputId.value = heightId.value"><output id="outputId" style="margin: 0 0 0 4%;">150</output>cm
      </td>
    </tr>
    <tr>
      <td>Tel:</td>
      <td>
        <input type="tel" name="phone" pattern="\+60\d{2}-\d{7}" placeholder="+60##-#######" autofocus><span style="margin: 0 9%;"></span>
      </td>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <input type="color" name="color" oninput="colorId.value = color.value">
      </td>
    </tr>
    <tr>
      <td>FB/TW/IG:</td>
      <td><input type="url" name="fbtwig" placeholder="URL for social media"></td>
    </tr>
    <tr>
      <td>My University:</td>
      <td>
...
<hr>
<input type="hidden" name="matricnum" value="a173630">
