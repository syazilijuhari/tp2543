...
<form action="validate_biodata.php" method="post" enctype="multipart/form-data">
  <table border="1" cellpadding="10">
    ...
    <tr>
      <td>Height:</td>
      <td>
        <input type="range" name="height" id="heightId" min = "100" max = "200" oninput="outputId.value = heightId.value" value="<?php echo $record['height']; ?>">
        <output id="outputId" style="margin: 0 0 0 4%"><?php echo $record['height']; ?></output>cm
      </td>
    </tr>
    <tr>
      <td>Tel:</td>
